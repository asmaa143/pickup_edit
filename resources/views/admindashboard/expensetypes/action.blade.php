<a href="{{route('expensetypes.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteexpensetypes({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deleteexpensetypes(sel){
    let id = sel;
 console.log(sel);
