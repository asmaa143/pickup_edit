<a href="{{route('cities.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecities({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
