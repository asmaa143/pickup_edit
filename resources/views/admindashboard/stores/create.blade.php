            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" required class="form-control" placeholder="  {{__('messages.name')}} " />
                    </div>
                </div>
                <!-- For loop this div -->
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" required name="cr_no" placeholder="{{__('messages.cr_no')}}" />
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                    <label>
                        ...
                        <input type="number" class="form-control" required name="tax_number" placeholder="{{__('messages.tax_number')}}" />
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text"  name="responsible_name" required class="form-control" placeholder=" {{__('messages.responsible_name')}} " />
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="number"  required name="responsible_phone" class="form-control"
                         placeholder=" {{__('messages.responsible_phone')}} " />
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" required  name="sales_officer" class="form-control"
                         placeholder=" {{__('messages.sales_officer')}} " />
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="email" required class="form-control" name="email" placeholder="   {{__('messages.email')}} " />
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="number" required class="form-control" name="phone" placeholder="    {{__('messages.phone')}} " />
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="password" id="txtPassword" nmae="password" required
