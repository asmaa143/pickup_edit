<a href="{{route('stores.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletestores({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
