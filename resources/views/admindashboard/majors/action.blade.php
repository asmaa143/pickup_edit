<a href="{{route('majors.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletemajors({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
