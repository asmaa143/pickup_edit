    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('featurestype.create')}}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            <table class="table" id="table">
                <thead class="thead-light">
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">أنواع المميزات</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Mark</td>
                        <td>
                            <a href="{{route('featurestype.edit',2)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
