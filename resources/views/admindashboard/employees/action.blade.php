<a href="{{route('employees.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteemployees({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
