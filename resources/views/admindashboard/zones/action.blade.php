<a href="{{route('zones.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletezones({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
