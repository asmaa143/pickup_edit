...
@section("content")
<form action="{{route('notifications.update',$notification->id)}}" method="post" enctype="multipart/form-data" class="avatar-upload">
@csrf
@method('PUT')
<!--begin::Card-->
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        @error('text') is-invalid @enderror" >{{ $notification->text }}</textarea>
                    </div>
                </div>
            </div>
        </div>
