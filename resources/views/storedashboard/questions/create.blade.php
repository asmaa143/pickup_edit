...
@section("content")
<form action="{{route('questions.store')}}"  enctype="multipart/form-data" 
    method="post">
@csrf
<!--begin::Card-->
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        @error('title-' . $lang->lang) is-invalid @enderror" rows="6">
              ...
              @foreach($store->languages as $lang)
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        @error('text-' . $lang->lang) is-invalid @enderror" rows="6">
                       </textarea>
