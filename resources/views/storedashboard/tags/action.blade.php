<a href="{{route('tags.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletetags({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
