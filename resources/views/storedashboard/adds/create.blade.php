...
@section('content')
    <form action="{{ route('adds.store') }}" enctype="multipart/form-data" method="POST" class="avatar-upload">
        @csrf
        <!--begin::Card-->
                            ...
                            @foreach ($store->languages as $lang)
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control
                          @error('extratitle-' . $lang->lang) is-invalid @enderror" name="extratitle-{{ $lang->lang }}[]" required value="{{ old('tiextratitlele-' . $lang->lang) }}" placeholder="{{ __('messages.title_' . $lang->lang) }}" />
                                        @error('title-' . $lang->lang) <span class="invalid-feedback">
                                            {{ $message }}</span> @enderror
                                    </div>
                                </div>
                        ...
                        <div class="row" style="position: relative;" id="removec0">
                            ...
                            <div class="col-md-4 col-9 d-flex align-items-center justify-content-center">
                                <div class="form-group w-100">
                                    ...
                                    <select class="form-control selectpicker" required name="product_id0[]" title=" {{ __('messages.product') }}">
