<a href="{{route('adds.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteadds({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
