...
@section("content")
<form action="{{route('categories.update',$category->id)}}"  enctype="multipart/form-data" method="post" class="avatar-upload">
@csrf
@method("PUT")
<!--begin::Card-->
        ...
        <div class="row">
                ...
                <div class="upload_img">
                    ...
                    <div class="avatar-preview container2">
                        <div id="imagePreview" style="background-image:url({{asset($category->image)}})">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control
                         ...
                         value="{{ $category->translate($lang->lang)->title }}"
