<a href="{{route('categories.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletecategories({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
