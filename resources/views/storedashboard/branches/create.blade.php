...
@section("content")
<form action="{{route('branches.store')}}"  method ="post" enctype="multipart/form-data" class="avatar-upload">
    @csrf
    <!--begin::Card-->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="phone" value="{{old('phone')}}" class="form-control" placeholder="{{__('messages.phone')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="whats_up" class="form-control" 
