<a href="{{route('branches.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
...
<div style="cursor:pointer;" onclick="deletebranches({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
