<a href="{{route('storeemployees.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletestoreemployees({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deletestoreemployees(sel){
    let id = sel;
 console.log(sel);
