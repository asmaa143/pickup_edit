<a href="{{route('drivers.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
...
<div style="cursor:pointer;" onclick="deletedrivers({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
