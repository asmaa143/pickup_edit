<a href="{{route('workshifts.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteworkshifts({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
