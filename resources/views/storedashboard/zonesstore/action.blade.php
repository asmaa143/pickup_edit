<a href="{{route('zonesstore.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletezonesstore({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
