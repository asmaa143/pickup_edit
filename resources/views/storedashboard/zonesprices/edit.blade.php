    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                {{ __('messages.addzoneprice') }}
            </div>
        </div>

        <div class="card-body price">

            <form action="{{ route('zonesprices.update', $zoneprice->id) }}" method="post">
                @csrf
                @method("PUT")
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" name="state_id" onchange="getstorecities(this)" data-live-search="true">
                                @foreach ($states as $state)
                                    <option value="{{ $state->id }}" @if ($zoneprice->zone->state_id == $state->id) selected @endif>{{ $state->title }}</option>
                                @endforeach
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" name="city_id" id="city" onchange="getstorezones(this)" data-live-search="true">

                                <option value="{{ $zoneprice->zone->city_id }}">{{ $zoneprice->zone->city->title }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" required id="zone" name="zone_id" data-live-search="true">
                                ...
                                <option value="{{ $zoneprice->zone_id }}">{{ $zoneprice->zone->title }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" required name="price" placeholder=" {{ __('messages.price') }}" value="{{ $zoneprice->price }}" />
                        </div>
                    </div>
                </div>
            </form>
