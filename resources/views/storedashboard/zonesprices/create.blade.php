                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" required name="price" placeholder=" {{ __('messages.price') }}" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control
                                          @error('title-' . $lang->lang) is-invalid @enderror" name="title-{{ $lang->lang }}" required value="{{ old('title-' . $lang->lang) }}" placeholder="{{ __('messages.zone_' . $lang->lang) }}" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" id="city1" name="city_id" data-live-search="true">
