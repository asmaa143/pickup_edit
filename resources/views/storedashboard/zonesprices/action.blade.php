<a href="{{route('zonesprices.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
...
<div style="cursor:pointer;" onclick="deletezonesprices({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
...
<script>
function deletezonesprices(sel){
let id = sel;
console.log(sel);
