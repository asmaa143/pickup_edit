...
class WorkShiftDataTable extends DataTable
{
    ...
    public function dataTable($query,Request $request)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'storedashboard.workshifts.action')
            ->rawColumns([
                'action',
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data'=>'fromtime','title'=>__("messages.fromtime")],
            ['data'=>'totime','title'=>__("messages.totime")],
